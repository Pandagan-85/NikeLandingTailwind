...
import { shoes, statistics } from "../costants";
...
const Hero = () => {
  ...
  return (
    <section
      ...
      id='home'
    >
      <div className='relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28  p-2'>
        ...
        <div className='flex justify-start items-start flex-wrap w-full mt-20 gap-16 max-sm:gap-12'>
